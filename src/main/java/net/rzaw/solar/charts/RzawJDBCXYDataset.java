    ...
    implements XYDataset, TableXYDataset, RangeInfo
{
    ...
    /**
     * Creates a new dataset using the specified database connection, and populates it using data obtained with the
     * supplied query.
     * 
     ...
     */
    public RzawJDBCXYDataset( Connection con, String query )
        throws SQLException
    {
        this( con );
        executeQuery( query );
    ...
    /**
     * ExecuteQuery will attempt execute the query passed to it against the existing database connection. If no
     * connection exists then no action is taken. The results from the query are extracted and cached locally, thus
    ...
    /**
     * ExecuteQuery will attempt execute the query passed to it against the provided database connection. If connection
     * is null then no action is taken. The results from the query are extracted and cached locally, thus applying an
    ...
    /**
     * Returns the x-value for the specified series and item. The implementation is responsible for ensuring that the
     * x-values are presented in ascending order.
     * 
     ...
     * @deprecated This method is not used in JFreeChart 1.0.x (it was left in the API by mistake and is officially
     *             deprecated from version 1.0.3 onwards).
     */
    @Deprecated
